...
2. **Choose your preferred installer**:
   - `HA Desktop Widget-2.3.8-win-x64-Setup.exe` (recommended - includes installer)
   - `HA Desktop Widget-2.3.8-win-x64-Portable.exe` (portable - no installation required)
