...
const Icons = {
  ...
  close: (options) =>
    createIcon(
      ...
      { ...options, ariaLabel: options?.ariaLabel || t('Close') }
    ),

  minimize: (options) =>
    createIcon('M19 13H5v-2h14v2z', { ...options, ariaLabel: options?.ariaLabel || t('Minimize') }),
  ...
  settings: (options) =>
    createIcon(
      ...
      { ...options, ariaLabel: options?.ariaLabel || t('Settings') }
    ),

  add: (options) =>
    createIcon('M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z', {
      ...options,
      ariaLabel: options?.ariaLabel || t('Add'),
    }),

  remove: (options) =>
    createIcon(
      'M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z',
      { ...options, ariaLabel: options?.ariaLabel || t('Remove') }
    ),

  edit: (options) =>
    createIcon(
      'M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z',
      { ...options, ariaLabel: options?.ariaLabel || t('Edit') }
    ),

  menu: (options) =>
    createIcon('M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z', {
      ...options,
      ariaLabel: options?.ariaLabel || t('Menu'),
    }),
  ...
  dragHandle: (options) =>
    createIcon(
      ...
      { ...options, ariaLabel: options?.ariaLabel || t('Drag to reorder') }
    ),
  ...
  undo: (options) =>
    createIcon(
      ...
      { ...options, ariaLabel: options?.ariaLabel || t('Undo') }
    ),

  // Media Controls
  play: (options) =>
    createIcon('M8 5v14l11-7z', { ...options, ariaLabel: options?.ariaLabel || t('Play') }),

  pause: (options) =>
    createIcon('M6 19h4V5H6v14zm8-14v14h4V5h-4z', {
      ...options,
      ariaLabel: options?.ariaLabel || t('Pause'),
    }),

  skipNext: (options) =>
    createIcon('M6 18l8.5-6L6 6v12zM16 6v12h2V6h-2z', {
      ...options,
      ariaLabel: options?.ariaLabel || t('Next'),
    }),

  skipPrevious: (options) =>
    createIcon('M6 6h2v12H6zm3.5 6l8.5 6V6z', {
      ...options,
      ariaLabel: options?.ariaLabel || t('Previous'),
    }),

  volumeUp: (options) =>
    createIcon(
      'M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02zM14 3.23v2.06c2.89.86 5 3.54 5 6.71s-2.11 5.85-5 6.71v2.06c4.01-.91 7-4.49 7-8.77s-2.99-7.86-7-8.77z',
      { ...options, ariaLabel: options?.ariaLabel || t('Volume') }
    ),
  ...
  power: (options) =>
    createIcon(
      ...
      { ...options, ariaLabel: options?.ariaLabel || t('Power') }
    ),
  ...
  brightness: (options) =>
    createIcon(
      ...
      { ...options, ariaLabel: options?.ariaLabel || t('Brightness') }
    ),
  ...
  weatherSnowy: (options) =>
    createIcon(
      ...
      { ...options, ariaLabel: options?.ariaLabel || t('Snowy') }
    ),

  waterDrop: (options) =>
    createIcon('M12 2.8S5.5 10.2 5.5 15.3a6.5 6.5 0 0 0 13 0C18.5 10.2 12 2.8 12 2.8Z', {
      ...options,
      ariaLabel: options?.ariaLabel || t('Humidity'),
    }),
  ...
  wind: (options) =>
    createIcon(
      ...
      {
        ...options,
        ariaLabel: options?.ariaLabel || t('Wind'),
      }
    ),
  ...
  camera: (options) =>
    createIcon(
      ...
      { ...options, ariaLabel: options?.ariaLabel || t('Camera') }
    ),

  videocam: (options) =>
    createIcon(
      'M17 10.5V7c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h12c.55 0 1-.45 1-1v-3.5l4 4v-11l-4 4z',
      { ...options, ariaLabel: options?.ariaLabel || t('Video') }
    ),
  ...
  warning: (options) =>
    createIcon('M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z', {
      ...options,
      ariaLabel: options?.ariaLabel || t('Warning'),
    }),

  error: (options) =>
    createIcon(
      'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z',
      { ...options, ariaLabel: options?.ariaLabel || t('Error') }
    ),

  checkCircle: (options) =>
    createIcon(
      'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z',
      { ...options, ariaLabel: options?.ariaLabel || t('Success') }
    ),

  info: (options) =>
    createIcon(
      'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z',
      { ...options, ariaLabel: options?.ariaLabel || t('Information') }
    ),
  ...
  notifications: (options) =>
    createIcon(
      ...
      { ...options, ariaLabel: options?.ariaLabel || t('Notifications') }
    ),
