...
const Icons = {
  ...
  minimize: (options) =>
    createIcon('M19 13H5v-2h14v2z', { ...options, ariaLabel: options?.ariaLabel || 'Minimize' }),
  ...
  add: (options) =>
    createIcon('M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z', {
      ...options,
      ariaLabel: options?.ariaLabel || 'Add',
    }),
  ...
  menu: (options) =>
    createIcon('M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z', {
      ...options,
      ariaLabel: options?.ariaLabel || 'Menu',
    }),
  ...
  undo: (options) =>
    createIcon(
      ...
      { ...options, ariaLabel: options?.ariaLabel || 'Undo' }
    ),

  // Media Controls
  play: (options) =>
    createIcon('M8 5v14l11-7z', { ...options, ariaLabel: options?.ariaLabel || 'Play' }),

  pause: (options) =>
    createIcon('M6 19h4V5H6v14zm8-14v14h4V5h-4z', {
      ...options,
      ariaLabel: options?.ariaLabel || 'Pause',
    }),

  skipNext: (options) =>
    createIcon('M6 18l8.5-6L6 6v12zM16 6v12h2V6h-2z', {
      ...options,
      ariaLabel: options?.ariaLabel || 'Next',
    }),

  skipPrevious: (options) =>
    createIcon('M6 6h2v12H6zm3.5 6l8.5 6V6z', {
      ...options,
      ariaLabel: options?.ariaLabel || 'Previous',
    }),
  ...
  warning: (options) =>
    createIcon('M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z', {
      ...options,
      ariaLabel: options?.ariaLabel || 'Warning',
    }),
  ...
  notifications: (options) =>
    createIcon(
      ...
      { ...options, ariaLabel: options?.ariaLabel || 'Notifications' }
    ),
