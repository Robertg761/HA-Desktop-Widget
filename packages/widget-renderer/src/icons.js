...
function createIcon(pathData, options = {}) {
  ...
  if (ariaLabel) {
    ...
    if (ariaLabelKey) svg.setAttribute('data-i18n-aria-label', ariaLabelKey);
  } else {
...
// An icon's built-in label keeps its key, so translateDocument relabels it after a language change.
function defaultAriaLabel(options, key) {
  return options?.ariaLabel ? {} : { ariaLabel: t(key), ariaLabelKey: key };
}
...
const Icons = {
  ...
  close: (options) =>
    createIcon(
      ...
      { ...options, ...defaultAriaLabel(options, 'Close') }
    ),

  minimize: (options) =>
    createIcon('M19 13H5v-2h14v2z', { ...options, ...defaultAriaLabel(options, 'Minimize') }),
  ...
  settings: (options) =>
    createIcon(
      ...
      { ...options, ...defaultAriaLabel(options, 'Settings') }
    ),

  add: (options) =>
    createIcon('M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z', {
      ...options,
      ...defaultAriaLabel(options, 'Add'),
    }),

  remove: (options) =>
    createIcon(
      'M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z',
      { ...options, ...defaultAriaLabel(options, 'Remove') }
    ),

  edit: (options) =>
    createIcon(
      'M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z',
      { ...options, ...defaultAriaLabel(options, 'Edit') }
    ),

  menu: (options) =>
    createIcon('M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z', {
      ...options,
      ...defaultAriaLabel(options, 'Menu'),
    }),
  ...
  dragHandle: (options) =>
    createIcon(
      ...
      { ...options, ...defaultAriaLabel(options, 'Drag to reorder') }
    ),
  ...
  undo: (options) =>
    createIcon(
      ...
      { ...options, ...defaultAriaLabel(options, 'Undo') }
    ),

  // Media Controls
  play: (options) =>
    createIcon('M8 5v14l11-7z', { ...options, ...defaultAriaLabel(options, 'Play') }),

  pause: (options) =>
    createIcon('M6 19h4V5H6v14zm8-14v14h4V5h-4z', {
      ...options,
      ...defaultAriaLabel(options, 'Pause'),
    }),

  skipNext: (options) =>
    createIcon('M6 18l8.5-6L6 6v12zM16 6v12h2V6h-2z', {
      ...options,
      ...defaultAriaLabel(options, 'Next'),
    }),

  skipPrevious: (options) =>
    createIcon('M6 6h2v12H6zm3.5 6l8.5 6V6z', {
      ...options,
      ...defaultAriaLabel(options, 'Previous'),
    }),

  volumeUp: (options) =>
    createIcon(
      'M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02zM14 3.23v2.06c2.89.86 5 3.54 5 6.71s-2.11 5.85-5 6.71v2.06c4.01-.91 7-4.49 7-8.77s-2.99-7.86-7-8.77z',
      { ...options, ...defaultAriaLabel(options, 'Volume') }
    ),
  ...
  power: (options) =>
    createIcon(
      ...
      { ...options, ...defaultAriaLabel(options, 'Power') }
    ),
  ...
  brightness: (options) =>
    createIcon(
      ...
      { ...options, ...defaultAriaLabel(options, 'Brightness') }
    ),

  // Weather Icons
  weatherSunny: (options) =>
    createIcon(
      'M6.76 4.84l-1.8-1.79-1.41 1.41 1.79 1.79 1.42-1.41zM4 10.5H1v2h3v-2zm9-9.95h-2V3.5h2V.55zm7.45 3.91l-1.41-1.41-1.79 1.79 1.41 1.41 1.79-1.79zm-3.21 13.7l1.79 1.8 1.41-1.41-1.8-1.79-1.4 1.4zM20 10.5v2h3v-2h-3zm-8-5c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm-1 16.95h2V19.5h-2v2.95zm-7.45-3.91l1.41 1.41 1.79-1.8-1.41-1.41-1.79 1.8z',
      { ...options, ...defaultAriaLabel(options, 'Sunny') }
    ),

  weatherCloudy: (options) =>
    createIcon(
      'M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96z',
      { ...options, ...defaultAriaLabel(options, 'Cloudy') }
    ),

  weatherRainy: (options) =>
    createIcon(
      ['M12 2c-5.33 4.55-8 8.48-8 11.8 0 4.98 3.8 8.2 8 8.2s8-3.22 8-8.2c0-3.32-2.67-7.25-8-11.8z'],
      { ...options, viewBox: '0 0 24 24', ...defaultAriaLabel(options, 'Rainy') }
    ),

  weatherSnowy: (options) =>
    createIcon(
  ...
  camera: (options) =>
    createIcon(
      ...
      { ...options, ...defaultAriaLabel(options, 'Camera') }
    ),

  videocam: (options) =>
    createIcon(
      'M17 10.5V7c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h12c.55 0 1-.45 1-1v-3.5l4 4v-11l-4 4z',
      { ...options, ...defaultAriaLabel(options, 'Video') }
    ),

  // Alerts & Notifications
  warning: (options) =>
    createIcon('M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z', {
      ...options,
      ...defaultAriaLabel(options, 'Warning'),
    }),

  error: (options) =>
    createIcon(
      'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z',
      { ...options, ...defaultAriaLabel(options, 'Error') }
    ),

  checkCircle: (options) =>
    createIcon(
      'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z',
      { ...options, ...defaultAriaLabel(options, 'Success') }
    ),

  info: (options) =>
    createIcon(
      'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z',
      { ...options, ...defaultAriaLabel(options, 'Information') }
    ),
  ...
  notifications: (options) =>
    createIcon(
      ...
      { ...options, ...defaultAriaLabel(options, 'Notifications') }
    ),
  ...
  refresh: (options) =>
    createIcon(
      ...
      { ...options, ...defaultAriaLabel(options, 'Refresh') }
    ),

  search: (options) =>
    createIcon(
      'M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z',
      { ...options, ...defaultAriaLabel(options, 'Search') }
    ),

  expandMore: (options) =>
    createIcon('M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z', {
      ...options,
      ...defaultAriaLabel(options, 'Expand'),
    }),

  expandLess: (options) =>
    createIcon('M12 8l-6 6 1.41 1.41L12 10.83l4.59 4.58L18 14z', {
      ...options,
      ...defaultAriaLabel(options, 'Collapse'),
    }),

  check: (options) =>
    createIcon('M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z', {
      ...options,
      ...defaultAriaLabel(options, 'Check'),
    }),
};
