...
describe('preload Electron API', () => {
  ...
  it('maps renderer methods to the intended IPC channels and arguments', async () => {
    ...
    const cases = [
      ...
      ['updateDesktopPinBounds', ['light.office', objectArg], 'update-desktop-pin-bounds', ['light.office', objectArg]],
      ['syncDesktopPinContentMinBounds', ['light.office', objectArg], 'sync-desktop-pin-content-min-bounds', ['light.office', objectArg]],
      ...
      ['requestDesktopPinAction', ['light.office', 'focus-main', objectArg], 'request-desktop-pin-action', ['light.office', 'focus-main', objectArg]],
      ['respondDesktopPinActionRequest', ['request-1', objectArg], 'desktop-pin-action-response', ['request-1', objectArg]],
      ...
      ['setProfileSyncPassphrase', ['secret', true], 'set-profile-sync-passphrase', ['secret', true]],
      ...
      ['quitApp', [], 'quit-app', []],
      ['registerHotkey', ['light.office', 'Ctrl+1', 'toggle'], 'register-hotkey', ['light.office', 'Ctrl+1', 'toggle']],
      ...
      ['setEntityAlert', ['sensor.temp', objectArg], 'set-entity-alert', ['sensor.temp', objectArg]],
      ...
      ['testHaConnection', ['https://ha.test', 'token'], 'test-ha-connection', ['https://ha.test', 'token']],
